...
<img src="/resources/photos/thumbnails/${photoDTO.fileName}" alt="Photo upload confirmation"/>
<%--zrobic walidację bo np .png niedozwolony format pliku --%>
<%--<img src="<c:url value="/resources/photos/${photoDTO.fileName}"/>" alt="Photo upload confirmation"/>--%>
...
<%--<img src="@{${'/photos/' + photoDTO.fileName}}" />--%>
</body>
</html>